...
KSYMTAB_DATA(dev_number, "", "");
KSYMTAB_DATA(stack_class, "", "");

SYMBOL_CRC(dev_number, 0x5b1888e1, "");
SYMBOL_CRC(stack_class, 0x77f02768, "");
...
MODULE_INFO(srcversion, "510161B45B5B6E241089E67");
